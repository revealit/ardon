...
var PostgresSQLBackend = function (configuration) {
  ...
  // Methods related to boards.
  self.board = {
    // Get one or more boards that match the specified conditions.
    // If no conditions are provided, return all boards visible to the user.
    get: function (options, callback) {
      self.connect(function (err) {
        ...
        // We have no advanced filters yet, so just run the query.
